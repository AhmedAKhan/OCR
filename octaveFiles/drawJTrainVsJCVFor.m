function nothing = drawJTrainVsJCVFor(xAxis)
...
costFunction = @(p, hiddenLayerSize) nnCostFunction(p, ...
                                   input_layer_size, ...
                                   hiddenLayerSize, ...
...
for hidden_layer_size = xAxis
 	fprintf('\tStarted training network for %i \n\t', hidden_layer_size)
	...
	[nn_params, cost] = fmincg(@(p)(costFunction(p, hidden_layer_size)), initial_nn_params, options);
